...
public class EmitDataActionImpl extends AbstractActionImpl implements EmitDataAction {
	...
	@Override
	public EList<DataSourceRole> getDataSourceRole() {
		return (EList<DataSourceRole>) eDynamicGet(ActionsPackage.EMIT_DATA_ACTION__DATA_SOURCE_ROLE,
	...
	public void eSet(int featureID, Object newValue) {
		...
		case ActionsPackage.EMIT_DATA_ACTION__EVENT_TYPE:
			...
			return;
		case ActionsPackage.EMIT_DATA_ACTION__DATA_SOURCE_ROLE:
			getDataSourceRole().clear();
			getDataSourceRole().addAll((Collection<? extends DataSourceRole>) newValue);
			return;
		case ActionsPackage.EMIT_DATA_ACTION__VARIABLE_REFERENCE:
	...
	public boolean eIsSet(int featureID) {
		...
		case ActionsPackage.EMIT_DATA_ACTION__DATA_SOURCE_ROLE:
			return !getDataSourceRole().isEmpty();
		case ActionsPackage.EMIT_DATA_ACTION__VARIABLE_REFERENCE:
