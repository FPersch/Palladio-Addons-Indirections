...
public class SystemPackageImpl extends EPackageImpl implements SystemPackage {
	 ...
	 */
	@Override
	public EAttribute getDataChannel_SpinType() {
	...
	public void createPackageContents() {
		...
		createEAttribute(dataChannelEClass, DATA_CHANNEL__SPIN_TYPE);
	}
	...
	public void initializePackageContents() {
		...
		initEAttribute(getDataChannel_PutPolicy(), theDatatypesPackage.getPutPolicy(), "putPolicy", null, 0, 1,
				DataChannel.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEAttribute(getDataChannel_SpinType(), theDatatypesPackage.getSpinType(), "spinType", null, 1, 1,
				DataChannel.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
