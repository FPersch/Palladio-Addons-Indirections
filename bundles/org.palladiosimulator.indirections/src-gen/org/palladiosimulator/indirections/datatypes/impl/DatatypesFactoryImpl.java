...
import org.palladiosimulator.indirections.datatypes.*;
...
public class DatatypesFactoryImpl extends EFactoryImpl implements DatatypesFactory {
	...
	public Object createFromString(EDataType eDataType, String initialValue) {
		...
		case DatatypesPackage.SPIN_TYPE:
			return createSpinTypeFromString(eDataType, initialValue);
		default:
	...
	public String convertToString(EDataType eDataType, Object instanceValue) {
		...
		case DatatypesPackage.SPIN_TYPE:
			return convertSpinTypeToString(eDataType, instanceValue);
		default:
			throw new IllegalArgumentException("The datatype '" + eDataType.getName() + "' is not a valid classifier");
		}
	}
	 ...
	 * @generated
	 */
	public PutPolicy createPutPolicyFromString(EDataType eDataType, String initialValue) {
		PutPolicy result = PutPolicy.get(initialValue);
		if (result == null)
			throw new IllegalArgumentException(
					"The value '" + initialValue + "' is not a valid enumerator of '" + eDataType.getName() + "'");
		return result;
	 ...
	 * @generated
	 */
	public String convertPutPolicyToString(EDataType eDataType, Object instanceValue) {
		return instanceValue == null ? null : instanceValue.toString();
	}
	 ...
	 * @generated
	 */
	public SpinType createSpinTypeFromString(EDataType eDataType, String initialValue) {
		SpinType result = SpinType.get(initialValue);
		if (result == null)
			throw new IllegalArgumentException(
					"The value '" + initialValue + "' is not a valid enumerator of '" + eDataType.getName() + "'");
		return result;
	 ...
	 * @generated
	 */
	public String convertSpinTypeToString(EDataType eDataType, Object instanceValue) {
		return instanceValue == null ? null : instanceValue.toString();
	}
