...
public class DatatypesPackageImpl extends EPackageImpl implements DatatypesPackage {
	 ...
	 * @generated
	 */
	private EEnum spinTypeEEnum = null;
	 ...
	 */
	@Override
	public EEnum getSpinType() {
		return spinTypeEEnum;
	}
	...
	public void createPackageContents() {
		...
		spinTypeEEnum = createEEnum(SPIN_TYPE);
	}
	...
	public void initializePackageContents() {
		...
		addEEnumLiteral(putPolicyEEnum, PutPolicy.OVERWRITE_LAST);

		initEEnum(outgoingDistributionEEnum, OutgoingDistribution.class, "OutgoingDistribution");
		addEEnumLiteral(outgoingDistributionEEnum, OutgoingDistribution.EXACTLY_ONE_CONSUMER);

		initEEnum(spinTypeEEnum, SpinType.class, "SpinType");
		addEEnumLiteral(spinTypeEEnum, SpinType.SPIN_ONCE);
		addEEnumLiteral(spinTypeEEnum, SpinType.SPIN);
